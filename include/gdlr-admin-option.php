								...
								'header-logo' => array(
									...
									'options' => array(							
										'header-style' => array(
											...
											'type' => 'combobox',
											'options' => array(
												'header-style-1' => esc_html__('Header Style 1', 'gdlr_translate'),
												'header-style-2' => esc_html__('Header Style 2', 'gdlr_translate'),
											)
										),							
							...
							'options' => array(
								...
								'top-bar-color' => array(
									...
									'options' => array(						
										...
										'main-navigation-background' => array(
											'title' => __('Main Navigation / Header Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'data-type' => 'rgba',
											'default' => '#000000',
											'selector'=> '.gdlr-navigation-wrapper.gdlr-fixed-nav,' .
												'.realsoccer-header-style-1 .gdlr-navigation-wrapper{ background: #gdlr#; background: rgba(#gdlra#, 0.7); }' .
												'.realsoccer-header-style-2 .gdlr-header-inner{ background: #gdlr#; background: rgba(#gdlra#, 0.7); }'
										),
										'main-navigation-background-hover' => array(
											'title' => __('Main Navigation Background Hover ( Header Style 1 )', 'gdlr_translate'),
											'type' => 'colorpicker',
											'data-type' => 'rgba',
											'default' => '#9b1a21',
											'selector'=> '.realsoccer-header-style-1 .gdlr-main-menu > li:hover > a, ' . 
												'.realsoccer-header-style-1 .gdlr-main-menu > li.current-menu-item > a, ' .
												'.realsoccer-header-style-1 .gdlr-main-menu > li.current-menu-ancestor > a{ background: #gdlr#; background: rgba(#gdlra#, 0.27); }'
										),
								...
								'league-table-color' => array(
									...
									'options' => array(
										...
										'recent-match-text' => array(
											'title' => __('Recent Match Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#222222',
											'selector'=> '.gdlr-recent-match-team-wrapper{ color: #gdlr#; } '
										),
										'recent-match-separator' => array(
											'title' => __('Recent Match Separator', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#8c8c8c',
											'selector'=> '.recent-match-item-wrapper .gdlr-recent-match-separator{ color: #gdlr#; } '
										),
